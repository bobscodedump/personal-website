    ...
    <div className='h-screen flex flex-col items-center w-[800px] pt-56 -mb-24 px-5' id='home'>
      <div className='flex flex-row items-center'>
        <div className='flex flex-col w-3/5 mt-24 ml-10'>
          ...
          <h2 className='font-raleway text-slate-800 w-40 text-sm sm:text-base'>
          ...
          <div className='flex flex-row mt-10 items-center'>
            <a href='https://github.com/bobscodedump' target='_blank'>
              <img src={github} className='w-6 h-6 sm:w-10 sm:h-10 mr-4' />
            </a>
            <a href='https://linkedin.com/in/sengkitt' target='_blank'>
              <img src={linkedin} className='w-7 h-6 sm:w-12 sm:h-10' />
            </a>
          </div>
        </div>
        <img src={pic} className='w-[150px] h-[150px] md:w-[400px] md:h-[400px] m-5' />
      </div>
      <div className='mt-10 flex flex-row items-center'>
        ...
        <div className='grid grid-cols-3 ml-20 md:flex md:flex-row items-center'>
